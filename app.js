const DATA_SHEET_ID = "1qi0rPdxZIW8D7NSZjseAA9OagX8jHM989Z5-r9o1rN4";

const SHEET_URLS = {
  students:
    "https://docs.google.com/spreadsheets/d/e/2PACX-1vSQM4fz2l8RqW6T_RpstTBH428nfaQuWLa0hCAljR-YSzSs3Z3Ac2UR11d306cs4PyrZzR6yrarvgOr/pub?gid=1626540029&single=true&output=csv",
  standards:
    "https://docs.google.com/spreadsheets/d/e/2PACX-1vSQM4fz2l8RqW6T_RpstTBH428nfaQuWLa0hCAljR-YSzSs3Z3Ac2UR11d306cs4PyrZzR6yrarvgOr/pub?gid=0&single=true&output=csv",
  skills:
    "https://docs.google.com/spreadsheets/d/e/2PACX-1vSQM4fz2l8RqW6T_RpstTBH428nfaQuWLa0hCAljR-YSzSs3Z3Ac2UR11d306cs4PyrZzR6yrarvgOr/pub?gid=429299684&single=true&output=csv",
};

const APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzQvB_EFn8IMxaqcfAC4MmAEHW-sxgSaSY9RfxgWfAGqq_DctMQ1trLgaoIwGZ2Be1eFg/exec";
const SCHOOL_NAME = "Sekolah Rendah Islam Integrasi Az-Zahra";
const SCHOOL_LOGO_URL = "https://iili.io/CqZ7uhG.jpg";
      ...
      <head>
        ...
        <style>
          * { box-sizing: border-box; }
          ...
          .print-title h3 { color: #0f4657; font-size: 10px; line-height: 1.1; margin: 2px 0 0; }
        ...
        <main class="print-page ${densityClass}">
          <div class="print-title">
            <div class="print-school">
              <img class="print-logo" src="${SCHOOL_LOGO_URL}" alt="Lencana sekolah" />
              <div>
